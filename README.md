...
docker run --name stock-price-db -e MYSQL_ROOT_PASSWORD=niki123 -p 8181:3306 -d mysql:latest
mysql --host 127.0.0.1 --port 8181 -uroot -pniki123 -e "CREATE DATABASE stockquotedb"
docker exec -i stock-price-db sh -c 'exec mysql -uroot -P8181 -pniki123 stockquotedb' < dump.sql
